  ...
  return (
    <>
      ...
      <p style={{ color: "var(--ink-70)", fontSize: 15 }}>
        SHIELD is strictly defensive: it watches security events, recognizes attacks,
        explains them in plain language, and drafts the containment — you approve before
        anything is blocked.
      </p>
      ...
      <ul style={{ color: "var(--ink-70)", fontSize: 14.5, lineHeight: 1.8 }}>
        ...
        <li><b>Prove your false-positive rate</b> — a 24-hour benign-traffic drill replays honest day-to-day activity through the same detector.</li>
      </ul>
      ...
      <div className="docs-steps">
        <div className="docs-step"><span className="n">1</span><div>Open <b>SHIELD</b> and click <b>⚡ Fire random attack</b> — try all five scenarios.</div></div>
